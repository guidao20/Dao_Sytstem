...
# Form implementation generated from reading ui file 'Eword_search_mode.ui'
#
...
"")
        ...
        self.label.setGeometry(QtCore.QRect(350, 20, 251, 51))
        font = QtGui.QFont()
        font.setFamily("华文楷体")
...
"")
        ...
        self.label_2.setGeometry(QtCore.QRect(60, 30, 101, 51))
        font = QtGui.QFont()
        font.setFamily("华文楷体")
        ...
        self.Qle.setGeometry(QtCore.QRect(140, 30, 611, 51))
        font = QtGui.QFont()
        font.setFamily("华文楷体")
        font.setPointSize(22)
        ...
        self.textBrowser_trans.setGeometry(QtCore.QRect(140, 130, 671, 241))
        font = QtGui.QFont()
        font.setFamily("华文楷体")
        ...
        self.textBrowser_senten = QtWidgets.QTextBrowser(self.widget_8)
        self.textBrowser_senten.setGeometry(QtCore.QRect(140, 390, 671, 251))
        font = QtGui.QFont()
        font.setFamily("华文楷体")
        font.setPointSize(16)
        self.textBrowser_senten.setFont(font)
        self.textBrowser_senten.setStyleSheet("background-color: rgb(0, 255, 255);")
        self.textBrowser_senten.setObjectName("textBrowser_senten")
        self.pushButton_2 = QtWidgets.QPushButton(self.widget_8)
        self.pushButton_2.setGeometry(QtCore.QRect(850, 170, 91, 51))
        font = QtGui.QFont()
        font.setFamily("华文楷体")
        font.setPointSize(22)
        ...
        self.pushButton_3.setGeometry(QtCore.QRect(850, 430, 91, 51))
        font = QtGui.QFont()
        font.setFamily("华文楷体")
        font.setPointSize(22)
        ...
        self.pushButton_4.setGeometry(QtCore.QRect(850, 270, 91, 51))
        font = QtGui.QFont()
        font.setFamily("华文楷体")
        font.setPointSize(22)
        ...
        self.pushButton_7.setGeometry(QtCore.QRect(850, 530, 91, 51))
        font = QtGui.QFont()
        font.setFamily("华文楷体")
        font.setPointSize(22)
        ...
        self.radioButton.setGeometry(QtCore.QRect(770, 40, 51, 30))
        ...
        self.pushButton_2.clicked.connect(Form.show_translation)
        self.pushButton_3.clicked.connect(Form.show_example)
        self.pushButton_4.clicked.connect(Form.clear_translation)
        self.pushButton_7.clicked.connect(Form.clear_example)
        self.pushButton_5.clicked.connect(Form.exit_search_word)
        self.pushButton_6.clicked.connect(Form.enter_into)
    ...
    def retranslateUi(self, Form):
        ...
        self.label.setText(_translate("Form", "Search word"))
        self.pushButton_6.setText(_translate("Form", "into"))
        self.label_2.setText(_translate("Form", "输入："))
        self.label_3.setText(_translate("Form", "词性："))
        self.label_4.setText(_translate("Form", "实例："))
        ...
        self.radioButton.setText(_translate("Form", "英"))
